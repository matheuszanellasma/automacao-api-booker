...
Site da API: https://restful-booker.herokuapp.com/apidoc/index.html
...
Com foco em garantir o comportamento esperado da API, foram mapeados e automatizados os seguintes cenários:
